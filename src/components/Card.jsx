                    ...
                    <div className="btn-group mt-2 me-3">
                        ...
                        <div className="btn-group float-sm-end">
                            <button type="button" className="btn btn-check">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2 icon-check" viewBox="0 0 16 16">
                                    <path d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0"/>
                                </svg>
                            </button>
                            <button type="button" className="btn btn-edit-card">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil icon-edit" viewBox="0 0 16 16">
                            ...
                            <button type="button" className="btn btn-remove-card">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash icon-remove" viewBox="0 0 16 16">
                ...
                <div className="btn-toolbar justify-content-between" role="toolbar">
                    ...
                    <div className="btn-group" role="group">
                        ...
                        <button className="btn btn-sort-cards">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-sort-down" viewBox="0 0 16 16">
